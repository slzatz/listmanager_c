...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("cpp",function(){"use strict";return function(e){
var i=e.requireLanguage("c-like").rawDefinition();return i.disableAutodetect=!1,
i.name="C++",i.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],i}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
begin:/\b(print|exec)\(/}]}}}());hljs.registerLanguage("plaintext",function(){"use strict";return function(t){
...
},{className:"string",begin:/'/,end:/'/},s]}}}());hljs.registerLanguage("go",function(){"use strict";return function(e){var n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}}());hljs.registerLanguage("c",function(){"use strict";return function(e){
